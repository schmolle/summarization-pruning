...
logging.basicConfig(filename='times.log', level=logging.DEBUG)
...
if pegasus_activate:
	...
	command_list.append("doPegasus(txt)")

#init Bart
if bart_activate:
	bart = pipeline("summarization", model="facebook/bart-large-cnn")
	command_list.append("doBart(txt)")
...
if bigbird_active:
	...
	command_list.append("doBigBird(txt)")
...
if __name__ == '__main__':
	...
	#	logging.info("%s called %d times took %s per run, %s in total" % (command, runs, time/runs, time))
	# print(doBigBird(txt))